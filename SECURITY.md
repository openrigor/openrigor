...
OpenRigor treats security as a merge-blocking concern. Authentication,
authorization, and attacker-controlled input are fixed before they land on
`main`. Other defects are tracked on the
[public board](https://github.com/openrigor/openrigor/issues).

## Supported versions

The public beta tracks the `main` branch of this repository and is hosted at
[openrigor.org](https://openrigor.org). That is the only supported line.
...
[GitHub security advisories](https://github.com/openrigor/openrigor/security/advisories/new)
or email **hello@openrigor.org** with:
...
[#43](https://github.com/evaluchat-origin/evaluchat-origin/issues/43) for the current Snyk
High on Next.js).
