...
function MermaidBlockRender(props: {
  block: { props: { data: string } };
  editor: {
    isEditable: boolean;
    updateBlock: (
      block: unknown,
      update: { props: { data: string; language: string } }
    ) => void;
  };
}) {
...
function MermaidToExternalHTML({
  block,
}: {
  block: { props: { data: string } };
}) {
...
export const MermaidBlock = createReactBlockSpec(
  ...
  {
    render: MermaidBlockRender as never,
    toExternalHTML: MermaidToExternalHTML as never,
