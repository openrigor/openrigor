  ...
  return (
    <>
      <section className="space-y-3">
        <p>
          These Terms of Service (“Terms”) govern access to and use of OpenRigor
      ...
      <section className="space-y-3">
        <h2>The Service</h2>
        <p>
          OpenRigor is an AI-assisted writing coaching platform for teaching. It
      ...
      <section className="space-y-3">
        ...
        <p>
          The coach can be wrong, incomplete, or uneven. OpenRigor is a teaching
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          materials). You grant OpenRigor a limited licence to host, process,
        ...
        <p>
          The OpenRigor product, branding, and software (aside from open-source
          components under their own licences, including lineage from LangChain
          OpenRigor) remain ours or our licensors’.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          To the fullest extent permitted by law, OpenRigor’s total liability
      ...
      <section className="space-y-3">
        <h2>Governing law</h2>
        <p>
          These Terms (as between you and OpenRigor regarding the Service) are
